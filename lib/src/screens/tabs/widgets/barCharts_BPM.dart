...
class BarChartBPM extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => BarChartBPMState();
}

class BarChartBPMState extends State<BarChartBPM>
    with AutomaticKeepAliveClientMixin<BarChartBPM> {
