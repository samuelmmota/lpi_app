...
class BarChartTensao extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => BarChartTensaoState();
}

class BarChartTensaoState extends State<BarChartTensao>
    with AutomaticKeepAliveClientMixin<BarChartTensao> {
...
//Query nameValorQuery = nameQuery.where('valor', isLessThan: '39');
        ...
        Future<Null> _weekbpm = bpm_time.get().then((querySnapshot) {
          ...
          sab.clear();
          dom.clear();
          print("#####: uma iteração feita (TENSAO-BAR Chart");
